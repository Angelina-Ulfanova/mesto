...
const setEventListeners = (forms, { inputSelector, submitButtonSelector, ...rest }) => {
    const formInputs = Array.from(forms.querySelectorAll(inputSelector));
    const formButton = forms.querySelector(submitButtonSelector);
